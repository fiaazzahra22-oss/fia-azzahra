...
<div class="container py-4">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4 gap-3">
        <div>
            ...
            <p class="text-muted mb-0">Manage your application users efficiently</p>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted text-uppercase" style="font-size: 0.7rem;">ID: #{{ $user->id }}</small>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td class="text-end pe-4">
                                <div class="btn-group" role="group">
                                    <a href="/user/{{ $user->id }}/edit" class="btn btn-outline-warning btn-sm">
                                        Edit
                                    </a>
